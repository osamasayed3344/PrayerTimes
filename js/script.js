...
$(document).ready(function() {
    $("#btngetprayer").click(function(e){
        ...
        if($("#getcity").val().trim()!=="" && $("#getcountry").val().trim()!==""){
            ...
            showprayer(localStorage.getItem("city"),localStorage.getItem("country"),year,month);
        }
    });
    ...
    if(savecity){
        showprayer(savecity,savecountry,year,month);
    }
});;

//-----------------------------------------عرض مواقيت الصلاة-----------------------------------
function showprayer(savecity,savecountry,year,month){
